...
int main(int argc, char **argv)
{
	...
	//for (t = -4; t < 4; t += .01)  //change the t range
	{
...
//////////////////////////////
		...
		//-----CHAMGE OUTPUT IMAGE "ofile" before running-----//
...
/////////////////////////////
	...
	ofile = "hw1_1b.ras";// this is the name of your output file, modify the name according to the requirements
